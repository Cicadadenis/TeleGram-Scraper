	...
	╔╦╗┌─┐┬  ┌─┐╔═╗  ╔═╗┌─┐┬─┐┌─┐┌─┐┌─┐┬─┐
	 ...
	 ╩ └─┘┴─┘└─┘╚═╝  ╚═╝└─┘┴└─┴ ┴┴  └─┘┴└─
		 ...
		 Anonimus cicada3301
			...
			print("[1] добавить участника по пользователю ID\n[2] добавить участника по имени пользователя ")
			mode = int(input("ввод : ")) 
			n = 0
				...
				if n % 50 == 0:
					...
					try:
						...
						if mode == 1:
							...
							sys.exit("[!] Выбран неверный режим. Пожалуйста, попробуйте снова.")
						client(InviteToChannelRequest(target_group_entity,[user_to_add]))
						print("[+] Ожидание 60-180 секунд...")
